...
<div class="text-center">
    <c:if test="${ID_EXIST != null}">
        <c:out value="${ID_EXIST}"/>
    </c:if>
</div>
<br>
<div>
    <form method="post">
        <div class="form-group row">
            ...
            <label class="col-md-2 colFormLabel">Product Code</label>
            <div class="col-md-4">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-4">
                <input class="form-control" type="text" name="product_desc" id="product_desc"
            ...
            <div class="col-md-4">
                <select class="form-control" id="exampleFormControlSelect1" name="category_id">
                    <c:forEach var="category" items="${categoryList}">
                        <option name="category_id" value="${category.categoryId}"><c:out value="${category.categoryName}"/></option>
                    </c:forEach>
                </select>
            </div>
        </div>
